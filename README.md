...
公开试玩版直接在浏览器的 Web Worker 中运行同一套 Bullet 物理，不需要房间服务器。支持选择轮数、自由投掷、真实碰撞音效及逐轮奖项回看，暂不开放多人联机。刷新页面会结束本次试玩。
...
- `npm test`：22项通过，包含高处释放取景、100次真实物理投掷和46,656种点数组合穷举。
...
- 网页已通过实际界面操作：创建→准备→开始→投掷→结算→重开→离房。检查1280桌面、390×844竖屏与浏览器错误日志。
